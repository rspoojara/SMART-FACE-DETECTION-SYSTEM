...
Button(win , text="<--",height=1,width=8,padx=5,pady=3,bg="#606060",fg="#FFFFFF").grid(sticky="w")
...
Button(frame, text="submit",command="connection",height=1,width=8,padx=5,pady=3,bg="#606060",fg="#FFFFFF").grid(columnspan=2,padx=3,pady=30)
