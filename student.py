...
class Student:
    def __init__(self,root):
        ...
        # f_lb1.place(x=0, y=0, width=500, hight=130)
        #
        # # third img
        # img2 = Image.open(
        #     r"-----------------------------------------------------------")
        ...
        title_lbl = Label(bg_img, text="Face Recognition Attedence System", font=("times new roman", 35, "bold"),
                          bg="white", fg="red")
        ...
        img_left = Image.open(r"C:\SFDS\images\studentDeteils.jpg")
        img_left = img_left.resize((635, 100), Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lb1 = Label(Left_frame, image=self.photoimg_left)
        f_lb1.place(x=5, y=0, width=635, height=100)

        # current course
        current_course_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RAISED,text="Current course imformation", font=("times new roman", 12, "bold"))
        current_course_frame.place(x=10, y=105, width=630, height=115)
        ...
        dep_combo["values"] = ("select Deprtment", "Computer", "IT", "Civil", "Mechnical")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("select course", "B.sc", "M.sc", "degree", "PHD")
        ...
        Year_combo["values"] = ("select Year", "First", "Second", "Third", "Four","Five")
        ...
        class_Student_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RAISED,
                                         text="Current course imformation", font=("times new roman", 12, "bold"))
        class_Student_frame.place(x=10, y=220, width=630, height=265)

        # student id
        studentId_lael = Label(class_Student_frame, text="Student Id", font=("times new roman", 12, "bold"), bg="white")
        studentId_lael.grid(row=0, column=0, padx=10, pady=5, sticky=W)
        ...
        # student name
        studentName_lael = Label(class_Student_frame,text="Student name", font=("times new roman", 12, "bold"), bg="white")
        studentName_lael.grid(row=0, column=2, padx=10, pady=5, sticky=W)

        studentID_entry = ttk.Entry(class_Student_frame, textvariable=self.var_std_name, width=16, font=("times new roman", 12, "bold"))
        ...
        # class_div_entry=ttk.Entry(class_Student_frame, textvariable=self.var_div,width=16,font=("times new roman",12,"bold"))
        ...
        div_combo.current(0)
        div_combo.grid(row=1, column=1, padx=2, pady=10)

        # Roll No
        roll_no_lael = Label(class_Student_frame, text="Roll No", font=("times new roman", 12, "bold"), bg="white")
        roll_no_lael.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        roll_no_entry = ttk.Entry(class_Student_frame,textvariable=self.var_roll, width=16, font=("times new roman", 12, "bold"))
        roll_no_entry.grid(row=1, column=3, padx=10, pady=5, sticky=W)

        # Gender
        geder_label = Label(class_Student_frame, text="Gender", font=("times new roman", 12, "bold"), bg="white")
        geder_label.grid(row=2, column=0, padx=10, pady=5, sticky=W)

        gender_combo = ttk.Combobox(class_Student_frame, textvariable=self.var_gender, font=("times new roman", 12, "bold"), state="readonly", width=14)
        ...
        address_entry = ttk.Entry(class_Student_frame,textvariable=self.var_address, width=16, font=("times new roman", 12, "bold"))
        ...
        btn_frame.place(x=0, y=215, width=635, height=30)

        save_btn = Button(btn_frame, text="Save",command=self.add_data, width=8, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        save_btn.grid(row=0, column=0)

        update_btn = Button(btn_frame, text="Update",command=self.update_data, width=8, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Delete",command=self.delete_data, width=8, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Reset",command=self.reset_data, width=8, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        reset_btn.grid(row=0, column=3)

#         # button2 frame
#         btn_frame1 = Frame(class_Student_frame, bd=2, relief=RIDGE, bg="white")
#         btn_frame1.place(x=0, y=235, width=715, height=50)

        take_photo_btn = Button(btn_frame,command=self.generate_dataset, text="Take photoSample", width=15, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        take_photo_btn.grid(row=0, column=4)

        update_photo = Button(btn_frame, text="Update PhotoSample", width=16, font=("times new roman", 12, "bold"), bg="blue", fg="white")
        update_photo.grid(row=0, column=5)
    ...
    def update_data(self):
        if self.var_dep.get() == "select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                messagebox.showinfo(
                    "Sucess", "Student details Succesfully update completed", parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
        ...
        if self.var_std_id.get() == "":
            ...
            try:
                delete = messagebox.askyesno(
                    "Student Delete PAge", "Do u want delete this student", parent=self.root)
                if delete > 0:
                        conn = mysql.connector.connect(
                            host="localhost", username="root", password="root", database="face_recognizer")
                        my_cursor = conn.cursor()
...
# =======================Generate data set or Take photo samples ===========
    def generate_dataset(self):
        ...
        # =========Load Predefined data on face frontals from opencv=====
                ...
                face_classifier = cv2.CascadeClassifier("haarcascade_frontalface_default.xml")  # Create File and give that name to file.
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path = "data/user." + str(id) + "." + str(img_id) + ".jpg"  # Make folder as Data for images
